...
def build_feedback_prompt(current_priority_func: str) -> str:
    """
    Build prompt for direct code generation without thought section.
    """
...
Write exactly one improved Python function named priority.
...
def run_real_api_experiment(api_key: str, num_iterations: int = 10, 
    ...
    print("="*70)
    print("DIRECT-CODE FUNSEARCH - REAL API RUN")
    print("="*70)
    ...
    print("  Mode: direct-code (no thought)")

    # Initialize
    llm = ThoughtsAugmentedLLM(samples_per_prompt=1, api_key=api_key, use_thoughts=False)
